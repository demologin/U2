package com.javarush.lesson20.calc;

import com.javarush.lesson20.calc.exception.CalcException;
...
public class MathProcessor {
    ...
    double calculate(String expression) throws CalcException {
        ...
        if (Double.isNaN(result)) {
            throw new CalcException("incomplete expression");
        }
        return result;
    }
}